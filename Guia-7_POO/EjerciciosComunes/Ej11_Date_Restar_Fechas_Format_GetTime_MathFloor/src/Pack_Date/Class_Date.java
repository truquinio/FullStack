...
//OBTENER FECHA ACTUAL:  / LocalDate.now() / Calendar.getInstance()
    ...
    public void diferencia(){
        ...
        Date fecha2 = new Date(anio, mes-1, dia);                             //Debo restar uno al mes, porque si no pasa al siguiente.-
        
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");            //Importo el formato de la fecha: dd/mm/yyyy.-
        
        String fecha1_str = sdf.format(fecha1);                               //Aplico el formato a fecha1.-
        String fecha2_str = sdf.format(fecha2);                               //Aplico formato a fecha2.-
        
        System.out.println("\n_ " + fecha1_str);                              //Imprimo la fecha1.-
        System.out.println("  " + fecha2_str + "\n");                         //Impromo la fecha2.-
        
        long resta = (fecha1.getTime() - fecha2.getTime());                   //Hago la resta de fechas.-
